...
<tr>
    <td style="background-image:url(../images/design/bg.gif); height:80px" valign="top" align="left">
      	<table width="100%" cellpadding="0" cellspacing="10" border="0">
        	<tr>
		  		<td>
					Der Eintrag der persistenten Welt wurde gelöscht.
				<td>
			</tr>
		</table>
	</td>
...
<tr>
    <td style="background-image:url(../images/design/bg.gif); height:80px" valign="top" align="left">
      	<table width="100%" cellpadding="0" cellspacing="10" border="0">
        	<tr>
		  		<td>
					Der Eintrag der persistenten Welt wurde geändert.
				<td>
			</tr>
		</table>
	</td>
...
else
{
		...
		echo'
                            ...
                            <tr>
                                <td class="config" valign="top">
                                    ...
                                    <font class="font-10">Was wird an Programmen benötigt?</font>
                                </td>
                                <td class="config" valign="top">
                                    <table width="100%">
										<tr>
	...
	echo'
                            ...
                            <tr>
                                <td class="config" valign="top">
                                    ...
                                    <font class="font-10">Anzahl der möglichen maximalen Spieleranzahl auf dem Server.</font>
                                </td>
                                <td class="config" valign="top">
	...
	echo'
                            ...
                            <tr>
                                <td class="config" valign="top">
                                    Items:<br>
                                    <font class="font-10">Häufigkeit besonderer/hochwertiger Items.</font>
                                </td>
                                <td class="config" valign="top">
