...
CREATE TABLE `fs_persistent` (
  ...
  `persistent_setting` varchar(200) NOT NULL default '',
  `persistent_genre` varchar(200) NOT NULL default '',
  `persistent_termine` varchar(200) NOT NULL default '',
  `persistent_dlsize` varchar(200) NOT NULL default '',
  `persistent_dlsvu` varchar(200) NOT NULL default '',
  `persistent_dlhdu` varchar(200) NOT NULL default '',
  `persistent_dlcep` varchar(200) NOT NULL default '',
  `persistent_dlmotb` varchar(200) default NULL,
  `persistent_anmeldung` varchar(200) NOT NULL default '',
  `persistent_handycap` text NOT NULL,
  `persistent_dm` varchar(200) NOT NULL default '',
  ...
  `persistent_fights` varchar(200) NOT NULL default '',
  `persistent_traps` varchar(200) NOT NULL default '',
  `persistent_items` varchar(200) NOT NULL default '',
